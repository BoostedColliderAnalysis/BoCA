...
#   message("LINKDEF: ${CMAKE_CURRENT_LIST_DIR}/../../../boca/${ARGV4}/${ARGV5}/${link_def} ")
#   message("LINKDEF: ../../../boca/${ARGV4}/${ARGV5}/${link_def} ")
    LIST(APPEND link_defs_2 ${CMAKE_CURRENT_LIST_DIR}/../../../boca/${ARGV4}/${ARGV5}/${link_def})
#     LIST(APPEND link_defs_2 ../../../boca/${ARGV4}/${ARGV5}/${link_def})
  endforeach()
  foreach(header ${headers})
#     LIST(APPEND headers_2 ../../../boca/${ARGV4}/${ARGV5}/${header})
    LIST(APPEND headers_2 ${CMAKE_CURRENT_LIST_DIR}/../../../boca/${ARGV4}/${ARGV5}/${header})
  endforeach()
  elseif(${ARGC} GREATER 4)
  foreach(link_def ${link_defs})
#     LIST(APPEND link_defs_2 ../../boca/${ARGV4}/${link_def})
    LIST(APPEND link_defs_2 ${CMAKE_CURRENT_LIST_DIR}/../../boca/${ARGV4}/${link_def})
  endforeach()
  foreach(header ${headers})
#     LIST(APPEND headers_2 ../../boca/${ARGV4}/${header})
    LIST(APPEND headers_2 ${CMAKE_CURRENT_LIST_DIR}/../../boca/${ARGV4}/${header})
  endforeach()
  else()
  foreach(link_def ${link_defs})
#     LIST(APPEND link_defs_2 ../boca/${link_def})
    LIST(APPEND link_defs_2 ${CMAKE_CURRENT_LIST_DIR}/../boca/${link_def})
  endforeach()
  foreach(header ${headers})
#     LIST(APPEND headers_2 ../boca/${header})
    LIST(APPEND headers_2 ${CMAKE_CURRENT_LIST_DIR}/../boca/${header})
  endforeach()
  endif()
