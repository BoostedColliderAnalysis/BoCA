...
//     DebugLevel = hanalysis::HObject::HDebug;
    ...
    HiggsTagger = new hdelphes::HMvaHiggsTagger();
...
//     if (JetPairs.size() <= 1) return 0;
    ...
    std::vector<HHiggsBranch *> Higgses = HiggsTagger->GetHiggsTag(Event, State, BottomTagger);
