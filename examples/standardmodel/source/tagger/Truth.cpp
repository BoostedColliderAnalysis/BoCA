...
int Truth::Train(boca::Event const& event, PreCuts const& pre_cuts, Tag)
{
    INFO0;
...
std::vector<TruthVariables> Truth::Multiplets(boca::Event const& event, PreCuts const& pre_cuts, TMVA::Reader const&)
{
    INFO0;
...
std::vector<TruthVariables> Truth::Jets(boca::Event const& event, PreCuts const& pre_cuts, std::function<Particle(Particle&)> const&)const
{
    INFO0;
