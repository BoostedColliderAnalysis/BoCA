...
int Boson::Train(boca::Event const& event, PreCuts const& pre_cuts, Tag tag)
{
    INFO0;
...
std::vector<Doublet> Boson::Doublets(boca::Event const& event, std::function<boost::optional<Doublet>(Doublet&)> const& function)
{
    INFO0;
...
std::vector<Particle> Boson::Particles(boca::Event const& event) const
{
    INFO0;
...
std::vector<Doublet> Boson::Multiplets(boca::Event const& event, PreCuts const& pre_cuts, TMVA::Reader const& reader)
{
    INFO0;
