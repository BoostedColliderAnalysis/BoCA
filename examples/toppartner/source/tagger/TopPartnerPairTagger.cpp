...
int TopPartnerPairTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<Decuplet55> TopPartnerPairTagger::Multiplets(boca::Event const& event, PreCuts const&, TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Decuplet55> TopPartnerPairTagger::Decuplets(boca::Event const& event, std::function<Decuplet55(Decuplet55&)> const& function)
{
    INFO0;
