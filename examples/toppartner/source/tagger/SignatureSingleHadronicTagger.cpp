 ...
 */
#include "include/tagger/SignatureSingleHadronicTagger.hh"
// #define INFORMATION
...
int SignatureSingleHadronicTagger::Train(boca::Event const& event, PreCuts const& , Tag tag)
{
    INFO0;
...
std::vector<Decuplet532> SignatureSingleHadronicTagger::Multiplets(boca::Event const& event, boca::PreCuts const& , TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Decuplet532> SignatureSingleHadronicTagger::Decuplets(boca::Event const& event, std::function<Decuplet532(Decuplet532&)> const& function)
{
    INFO0;
