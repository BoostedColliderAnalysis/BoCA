...
int SignatureHiggsPartnerPairTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<Duodecuplet552> SignatureHiggsPartnerPairTagger::Multiplets(boca::Event const& event, boca::PreCuts const&, TMVA::Reader const& reader)
{
    INFO0;
