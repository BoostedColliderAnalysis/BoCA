...
int CompleteSingleHadronicTagger::Train(boca::Event const& event, PreCuts const& , Tag tag)
{
    INFO0;
...
std::vector<EventMultiplet<Decuplet532>> CompleteSingleHadronicTagger::Multiplets(boca::Event const& event, boca::PreCuts const& , TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<EventMultiplet<Decuplet532>> CompleteSingleHadronicTagger::Decuplets(boca::Event const& event, std::function<EventMultiplet<Decuplet532>(boca::EventMultiplet<Decuplet532>&)> const& function)
{
    INFO0;
