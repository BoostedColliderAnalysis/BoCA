...
int TopPartnerLeptonicNeutralTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<Quintet> TopPartnerLeptonicNeutralTagger::Quintets(boca::Event const& event, std::function<Quintet(Quintet&)> const& function)
{
...
std::vector<Quintet> TopPartnerLeptonicNeutralTagger::Multiplets(boca::Event const& event, boca::PreCuts const&, TMVA::Reader const& reader)
{
...
std::vector<Particle> TopPartnerLeptonicNeutralTagger::Particles(boca::Event const& event, Tag tag) const
{
