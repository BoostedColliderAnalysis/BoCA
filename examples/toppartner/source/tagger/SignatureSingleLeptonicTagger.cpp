...
int SignatureSingleLeptonicTagger::Train(boca::Event const& event, PreCuts const& , Tag tag)
{
    INFO0;
...
std::vector<Decuplet532> SignatureSingleLeptonicTagger::Multiplets(boca::Event const& event, boca::PreCuts const& , TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Decuplet532> SignatureSingleLeptonicTagger::Decuplets(boca::Event const& event, std::function<Decuplet532(Decuplet532&)> const& function)
{
  INFO0;
