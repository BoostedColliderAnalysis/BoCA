...
int EventPairTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<EventMultiplet<Decuplet55>> EventPairTagger::Events(boca::Event const& event, std::function<EventMultiplet<Decuplet55>(boca::EventMultiplet<Decuplet55> &)> const& function)
{
    INFO0;
...
latex::String EventPairTagger::LatexName() const
{
