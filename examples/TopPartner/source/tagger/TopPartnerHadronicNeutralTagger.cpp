...
int TopPartnerHadronicNeutralTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<Quintet> TopPartnerHadronicNeutralTagger::Multiplets(boca::Event const& event, boca::PreCuts const&, TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Quintet> TopPartnerHadronicNeutralTagger::Quintets(boca::Event const& event, std::function<Quintet(Quintet&)> const& function)
{
    INFO0;
...
std::vector<Particle> TopPartnerHadronicNeutralTagger::Particles(boca::Event const& event) const
{
    INFO0;
