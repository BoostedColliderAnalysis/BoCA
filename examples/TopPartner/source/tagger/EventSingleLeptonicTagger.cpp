...
int EventSingleLeptonicTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
  INFO0;
...
std::vector<EventMultiplet<Decuplet532>> EventSingleLeptonicTagger::Events(boca::Event const& event, std::function<EventMultiplet<Decuplet532>(boca::EventMultiplet<Decuplet532> &)> const& function)
{
  INFO0;
