...
int HiggsPairTagger::Train(boca::Event const& event, PreCuts const&, Tag tag)
{
    INFO0;
...
std::vector<Quartet22> HiggsPairTagger::Multiplets(boca::Event const& event, boca::PreCuts const&, TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<std::pair<Particle, Particle>> HiggsPairTagger::Particles(boca::Event const& event, Tag tag) const
{
...
std::vector<Quartet22> HiggsPairTagger::Quartets(boca::Event const& event, std::function<Quartet22(Quartet22&)> const& function)
{
    INFO0;
