...
int VetoTopPartnerLeptonicTagger::Train(boca::Event const& event, PreCuts const& , Tag tag)
{
    INFO0;
...
std::vector<Quintet> VetoTopPartnerLeptonicTagger::Multiplets(boca::Event const& event, boca::PreCuts const& , TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Particle> VetoTopPartnerLeptonicTagger::Particles(boca::Event const& event) const
{
...
std::vector<Quintet> VetoTopPartnerLeptonicTagger::Quintets(boca::Event const& event, std::function<Quintet(Quintet&)> const& function)
{
    INFO0;
