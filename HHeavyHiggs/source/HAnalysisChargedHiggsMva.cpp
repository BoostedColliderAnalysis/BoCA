...
HStrings hheavyhiggs::HAnalysisCharged::JoinHStrings(const HStrings &Strings1, const HStrings &Strings2)
{
...
std::vector<hanalysis::HFile *>  hheavyhiggs::HAnalysisCharged::JoinFiles(const std::vector< hanalysis::HFile * > &Files1, const std::vector< hanalysis::HFile * > &Files2)
{
...
//       case HWHadronicReader :
//         if (Tag == HSignal) PrepareReader(HBottomTagger);
//         if (Tag == HSignal) PrepareReader(HWHadronicReader);
//         break;
//       case HTopLeptonicTagger:
//       case HTopLeptonicReader  :
//       case HHeavyHiggsLeptonicTagger  :
...
//         if (Tagger == HWSemiTagger) break;
//         //         WSemiReader.SetMva(WSemiTagger);
//         if (Tagger == HWSemiReader) break;
//
//         //         TopHadronicTagger = new hanalysis::HTopHadronicTagger(BottomTagger, WHadronicTagger);
// //         TopHadronicTagger = hanalysis::HTopHadronicTagger(BottomTagger, WHadronicTagger);
// //         TopHadronicTagger.SetAnalysisName(GetProjectName());
// //         TopHadronicTagger.SetSignalTreeNames(NotLeptonicTrees);
// //         TopHadronicTagger.SetBackgroundTreeNames(NotLeptonicTrees);
//         if (Tagger == HTopHadronicTagger)  break;
//         //         TopHadronicReader.SetMva(TopHadronicTagger);
//
//
//         //         TopSemiTagger = new hanalysis::HTopSemiTagger(BottomTagger, WSemiTagger);
// //         TopSemiTagger = hanalysis::HTopSemiTagger(BottomTagger, WSemiTagger);
// //         TopSemiTagger.SetAnalysisName(GetProjectName());
// //         TopSemiTagger.SetSignalTreeNames(SemiTrees);
// //         TopSemiTagger.SetBackgroundTreeNames(SemiTrees);
// //         if (Tagger == HTopSemiTagger) break;
// //         //         TopSemiReader.SetMva(TopSemiTagger);
// //         if (Tagger == HTopSemiReader) break;
//
//         //         HeavyHiggsSemiTagger = new hanalysis::HHeavyHiggsSemiTagger(BottomTagger, WSemiTagger, WHadronicTagger, TopSemiTagger, TopHadronicTagger);
//         HeavyHiggsSemiTagger = hanalysis::HHeavyHiggsSemiTagger(BottomTagger, WSemiTagger, WHadronicTagger, TopSemiTagger, TopHadronicTagger);
//         HeavyHiggsSemiTagger.SetAnalysisName(GetProjectName());
//         HeavyHiggsSemiTagger.SetSignalTreeNames(SignalSemiTrees);
//         HeavyHiggsSemiTagger.SetBackgroundTreeNames(BackgroundSemiTrees);
//         if (Tagger == HHeavyHiggsSemiTagger)  break;
//         //         HeavyHiggsSemiReader.SetMva(HeavyHiggsSemiTagger);
//         if (Tagger == HHeavyHiggsSemiReader) break;
//
//         //         EventSemiTagger = new hheavyhiggs::HEventSemiTagger(BottomTagger, JetPairTagger, WSemiTagger, WHadronicTagger, TopSemiTagger, TopHadronicTagger, HeavyHiggsSemiTagger);
//         EventSemiTagger = hheavyhiggs::HEventSemiTagger(BottomTagger, JetPairTagger, WSemiTagger, WHadronicTagger, TopSemiTagger, TopHadronicTagger, HeavyHiggsSemiTagger);
//         EventSemiTagger.SetAnalysisName(GetProjectName());
//         EventSemiTagger.SetSignalTreeNames(SignalSemiTrees);
//         EventSemiTagger.SetBackgroundTreeNames(BackgroundSemiTrees);
//         if (Tagger == HEventSemiTagger)  break;
...
// //         if (Tagger == HTopHadronicTagger)  break;
//         //         TopHadronicReader.SetMva(TopHadronicTagger);
// //         if (Tagger == HTopHadronicReader)  break;
//
...
bool hheavyhiggs::HAnalysisCharged::GetHeavyHiggsLeptonicTag(hanalysis::HEvent *const Event, const HTag Tag)
{
...
bool hheavyhiggs::HAnalysisCharged::GetHeavyHiggsLeptonicReader(hanalysis::HEvent *const Event, const HTag Tag)
{
    Print(HInformation, "Get Event semi", Tag);
...
bool hheavyhiggs::HAnalysisCharged::GetHeavyHiggsHadronicTag(hanalysis::HEvent *const Event, const HTag Tag)
{
...
bool hheavyhiggs::HAnalysisCharged::GetHeavyHiggsSemiTag(hanalysis::HEvent *const Event, const HTag Tag)
{
...
bool hheavyhiggs::HAnalysisCharged::GetHeavyHiggsSemiReader(hanalysis::HEvent *const Event, const HTag Tag)
{
    Print(HInformation, "Get Event semi", Tag);
...
bool hheavyhiggs::HAnalysisCharged::GetEventLeptonicTag(hanalysis::HEvent *const Event, const HTag Tag)
{
...
bool hheavyhiggs::HAnalysisCharged::GetEventHadronicTag(hanalysis::HEvent *const Event, const HTag Tag)
{
...
bool hheavyhiggs::HAnalysisCharged::GetEventLeptonicReader(hanalysis::HEvent *const Event, const HTag Tag)
{
