...
BottomBranch hbtagger::BottomTaggerSimple::GetBranch(const fastjet::PseudoJet &jet) const
{
    ...
    branch.VertexDeltaR = DeltaR(jet.user_info<hanalysis::JetInfo>().VertexJet());
    branch.VertexSpread = Spread(jet.user_info<hanalysis::JetInfo>().VertexJet());
...
//     bottom_branch.BTag = Jet.user_info<hanalysis::JetInfo>().BTag();
    branch.Tag = jet.user_info<hanalysis::JetInfo>().Tag();
    branch.Bdt = jet.user_info<hanalysis::JetInfo>().Bdt();
