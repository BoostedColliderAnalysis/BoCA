...
{
  toppartner::Analysis analysis(tagger);
...
int main()
{
  ...
  toppartner::HiggsPairTagger higgs_pair_tagger;
  ...
  toppartner::TopPartnerHadronicTagger top_partner_hadronic_tagger;
  ...
  toppartner::TopPartnerSemiTagger top_partner_semi_tagger;
  ...
  toppartner::TopPartnerPairTagger top_partner_pair_tagger;
  ...
  toppartner::SignatureTagger signature_tagger;
  ...
  toppartner::EventTagger event_tagger;
