...
std::vector<EventMultiplet<Decuplet55>> EventPairTagger::Multiplets(boca::Event const& event, boca::PreCuts const&, TMVA::Reader const& reader) const
{
    INFO0;
...
std::vector<EventMultiplet<Decuplet55>> EventPairTagger::Events(Event const& event, std::function<EventMultiplet<Decuplet55>(EventMultiplet<Decuplet55> &)> const& function) const
{
    INFO0;
