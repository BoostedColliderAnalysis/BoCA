...
macro(create_test name source)
  ...
  target_link_libraries(${testname} ${link_libraries} ${GTEST_LIBRARIES} pthread)
  target_compile_features(${testname} PRIVATE ${compile_features})
  if(${CMAKE_BUILD_TYPE} MATCHES DEBUG AND iwyu_path)
    set_property(TARGET ${testname} PROPERTY CXX_INCLUDE_WHAT_YOU_USE ${iwyu_path})
  endif()
