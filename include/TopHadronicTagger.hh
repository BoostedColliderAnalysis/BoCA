...
private:
    ...
    analysis::Triplet Triplet(const Doublet& doublet, const fastjet::PseudoJet& jet, const Jets& leptons, const PreCuts& pre_cuts, const Tag tag, const bool check_overlap = false) const;

    analysis::Triplet Triplet(analysis::Triplet& triplet, const analysis::Jets& leptons, const analysis::PreCuts& pre_cuts, const analysis::Tag tag) const;

    std::vector<analysis::Triplet> Triplets(const std::vector<Doublet>& doublets, const Jets& jets, const Jets& leptons, const PreCuts& pre_cuts, const Tag tag) const;

    std::vector<analysis::Triplet> Triplets(const Doublet& doublet, const Jets& jets, const Jets& leptons, const PreCuts& pre_cuts, const Tag tag) const;
    ...
    bool Problematic(const analysis::Triplet& triplet, const PreCuts& pre_cuts, const Tag tag) const;
