...
Family::Family(const int particle_id) {
...
Family::Family(const int particle_id, const int mother_id) {
  particle_.Id = particle_id;
...
Family::Family(const int particle_id, const int mother_1_id, const int mother_2_id) {
  particle_.Id = particle_id;
...
Family::Family(const int particle_position, const int particle_id, const int mother_position, const int mother_id) {
...
Family::Family(const TLorentzVector &particle, const TLorentzVector &mother, const int particle_position, const int particle_id, const int mother_position, const int mother_id) {
