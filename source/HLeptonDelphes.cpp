...
//                 JetInfo->AddConstituent(GetBranchFamily(ElectronClone->Particle.GetObject()), std::abs(ElectronClone->PT));
...
//                 Print(HDebug, "Electron Tag", ElectronJets.back().user_info<hanalysis::HJetInfo>().MaximalId());
            }
