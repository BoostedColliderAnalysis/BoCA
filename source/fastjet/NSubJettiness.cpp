...
NSubJettiness::NSubJettiness(Jet const& jet, fastjet::contrib::AxesDefinition const& axes, int beta)
{
    ...
    tau_1_ = n_subjettiness_1.result(jet);
    tau_2_ = n_subjettiness_2.result(jet);
    tau_3_ = n_subjettiness_3.result(jet);
    tau_2_1_ = n_subjettiness_21.result(jet);
    tau_3_2_ = n_subjettiness_32.result(jet);
}
