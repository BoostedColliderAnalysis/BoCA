...
// }
// 
// void Analysis::AnalysisLoop(const analysis::Stage stage)
// {
...
// }
// 
// std::string Analysis::ExportName(const analysis::Stage stage, const Tag tag) const
// {
//     Info(tagger_.name(stage, tag));
...
// {
//     Info(export_tree_name.c_str());
//     exroot::TreeWriter tree_writer(&export_file, export_tree_name.c_str());
//     tagger_.SetTreeBranch(tree_writer, stage);
//     return tree_writer;
// }
// 
// int Analysis::RunAnalysis(Event &event, const analysis::Stage stage, const Tag tag)
// {
//     Info();
//     switch (stage) {
//     case Stage::trainer :
