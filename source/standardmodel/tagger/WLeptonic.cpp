...
int WLeptonic::Train(Event const& event, boca::PreCuts const& pre_cuts, Tag tag)
{
    INFO0;
...
std::vector<Particle> WLeptonic::Particles(Event const& event) const
{
    INFO0;
...
std::vector<Doublet> WLeptonic::Multiplets(Event const& event, PreCuts const& pre_cuts, TMVA::Reader const& reader)
{
    INFO0;
...
std::vector<Doublet> WLeptonic::Doublets(Event const& event, std::function<boost::optional<Doublet>(Doublet&)> const& function) const
{
    INFO0;
